...
int reg_tcp_conn_ebpf(struct tcp_connection *c, bool listen)
{
    ...
    etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.rate = CC_DCTCP_MIN;
    etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.cnt_tx_drops = 0;
    etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.cnt_rx_acks = 0;
    etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.cnt_rx_ack_bytes = 0;
    etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.cnt_rx_ecn_bytes = 0;
    etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.rtt_est = 0;
...
{
    stats->c_drops = etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.cnt_tx_drops;
    stats->c_acks = etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.cnt_rx_acks;
    stats->c_ackb = etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.cnt_rx_ack_bytes;
    stats->c_ecnb = etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.cnt_rx_ecn_bytes;
    stats->txp = etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.txp;
    stats->rtt = etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.rtt_est;
...
void set_cc_rate(uint32_t cc_idx, uint32_t new_rate)
{
    ...
    if (v > 3125000000)
        v = 3125000000; // 25Gbps
    etran_tcp->_tcp_cc_map_mmap->entry[cc_idx].mtp_cc.rate = v;
}
