...
/* ---- prototypes----------------------------------------- */
static __always_inline void proc_ack(struct tcp_ack *ev, struct bpf_tcp_conn *ctx_ebpf, struct bpf_cc *ctx_cc_shared, struct gen_tcp_scratch *s);
static __always_inline void proc_fast_retransmit(struct tcp_ack *ev, struct bpf_tcp_conn *ctx_ebpf, struct bpf_cc *ctx_cc_shared, struct gen_tcp_scratch *s);
static __always_inline void proc_window(struct tcp_ack *ev, struct bpf_tcp_conn *ctx_ebpf, struct gen_tcp_scratch *s);
static __always_inline void proc_rtt(struct tcp_ack *ev, struct bpf_tcp_conn *ctx_ebpf, struct bpf_cc *ctx_cc_shared, struct gen_tcp_scratch *s);
static __always_inline void proc_seq(struct tcp_data *ev, struct bpf_tcp_conn *ctx_ebpf, struct gen_tcp_scratch *s);
static __always_inline void proc_ooo(struct tcp_data *ev, struct bpf_tcp_conn *ctx_ebpf, struct gen_tcp_scratch *s);
static __always_inline void proc_recv(struct tcp_data *ev, struct bpf_tcp_conn *ctx_ebpf, struct gen_tcp_scratch *s);
static __always_inline void gen_retransmit(struct rto_timeout *ev, struct bpf_tcp_conn *ctx_ebpf, struct gen_tcp_tx_scratch *s);
static __always_inline void send_wnd_update(struct app_recv *ev, struct bpf_tcp_conn *ctx_ebpf, struct gen_tcp_tx_scratch *s);
static __always_inline void gen_seg(struct app_send *ev, struct bpf_tcp_conn *ctx_ebpf, struct bpf_cc *ctx_cc_shared, struct gen_tcp_tx_scratch *s);
