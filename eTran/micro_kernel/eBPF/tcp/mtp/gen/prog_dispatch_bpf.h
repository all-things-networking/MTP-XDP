...
/* ---- dispatch [ebpf]------------------------------------ */
static inline void mtp_dispatch_app_send_ebpf(struct app_send *ev, struct bpf_tcp_conn *c_tcp_ctx_ebpf, struct bpf_cc *c_tcp_ctx_cc_shared, struct tcp_tx_scratch *s)
{
    gen_seg(ev, c_tcp_ctx_ebpf, c_tcp_ctx_cc_shared, s);
}

static inline void mtp_dispatch_app_recv_ebpf(struct app_recv *ev, struct bpf_tcp_conn *c_tcp_ctx_ebpf, struct tcp_tx_scratch *s)
{
...
static inline void mtp_dispatch_rto_timeout_ebpf(struct rto_timeout *ev, struct bpf_tcp_conn *c_tcp_ctx_ebpf, struct tcp_tx_scratch *s)
{
