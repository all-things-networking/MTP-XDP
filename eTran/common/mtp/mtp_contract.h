...
void  mtp_init (void *w, __u32 at);
void  mtp_set  (void *w, __u32 from, __u32 to);
__u32 mtp_slide(void *w);
__u32 mtp_head (void *w);
 ...
 */
__u32 mtp_len        (void *recv);
void  mtp_push       (void *recv, __u64 v);
__u64 mtp_pop        (void *recv);
void  mtp_remove     (void *recv, __u64 v);
__u32 mtp_first      (void *recv);
__u32 mtp_last       (void *recv);
bool  mtp_is_set     (void *recv, __u32 at);
__u32 mtp_first_set  (void *recv);
__u32 mtp_first_unset(void *recv);
__u32 mtp_find_ge    (void *recv, __u32 from);
__u32 mtp_find_min   (void *recv);
bool  mtp_exists_ge  (void *recv, __u32 from);
...
/* On a timer. */
void  mtp_start       (void *t, __u64 d);
void  mtp_cancel      (void *t);
void  mtp_restart     (void *t, __u64 d);
void  mtp_set_duration(void *t, __u64 d);
bool  mtp_isActive    (void *t);
 ...
 */
void  mtp_rx_new(void *stream, __u32 cap);
void  mtp_tx_new(void *stream, __u32 cap);
...
__s32 mtp_rx_add(void *stream, struct mtp_addr addr, __u32 len, __u32 off);
 ...
 * target one. */
__u32 mtp_tx_add(void *stream, struct mtp_addr addr, __u32 len);
struct mtp_addr mtp_tx_addr(void *stream, __u32 off);
__u32 mtp_rx_flush(void *stream, __u32 len, struct mtp_addr buf);
__u32 mtp_tx_flush(void *stream, __u32 len);
...
struct mtp_addr mtp_seg(void *stream, __u32 off, __u32 len, __u32 mss);
struct mtp_addr mtp_unseg(void *stream, __u32 off, __u32 len, __u32 mss);
